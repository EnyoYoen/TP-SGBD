...
SELECT DISTINCT c.code, l.lake
    FROM country c LEFT OUTER JOIN geo_lake l on c.code = l.country -- LEFT OUTER JOIN pour les pays qui n'ont pas de lacs sur leur territoire (peu probable pour des pays aussi grands)
    WHERE area >= 8000000
